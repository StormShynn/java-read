...
})(
  {
    ...
    CjX8: [
      function (require, module, exports) {
        module.exports = {
          upload_desc:
            "Click to select a file, or drag and drop it here (<b>.class</b> or <b>.jar</b>)",
          loading: "Loading file...",
          invalid_file_format:
            "Invalid file format! Accepted file formats are <b>.jar</b> or <b>.class</b>.",
    ...
    aOs5: [
      function (require, module, exports) {
        module.exports = {
          upload_desc:
            "Clique para selecionar ou arraste o arquivo (<b>.class</b> ou <b>.jar</b>) até aqui.",
          loading: "Carregando arquivo...",
          invalid_file_format:
            "Tipo de arquivo inválido! Os tipos aceitos são <b>.jar</b> ou <b>.class</b>.",
    ...
    FOZT: [
      function (require, module, exports) {
        ...
        function a() {
          for (var t = 10, n = ""; t--; ) {
            var r = (3 * Math.random()) | 0,
              e = void 0;
            0 === r
              ? (e = (97 + 25 * Math.random()) | 0)
              : 1 === r
              ? (e = (65 + 25 * Math.random()) | 0)
              : 2 === r && (e = (48 + 9 * Math.random()) | 0),
              (n += String.fromCharCode(e));
          }
          return n;
        }
        function s(t) {
          for (var n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
          return n;
        }
        function i(t) {
        ...
        function u(t) {
          var n = t.lastIndexOf("/");
          return { folder: t.substring(0, n), fileName: t.substring(n + 1) };
        }
    ...
    JCoI: [
      function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: !0 }),
          (exports.SIMULATE_LATENCY =
            exports.DISABLE_DECOMPILED_CODE_CACHE =
            exports.API_BASE =
              void 0);
    ...
    A2T1: [
      function (require, module, exports) {
        ...
        function x(e) {
          ...
          if ((n.classList.remove("drag-over"), e && 0 !== e.length)) {
            var r = e[0];
            r.name.endsWith(".jar") || r.name.endsWith(".class")
              ? (n.setAttribute("x-selected", "true"), Z(r))
              : G(t.default.invalid_file_format, 2500, !0);
          } else G(t.default.invalid_file_format, 2500, !0);
        }
        function S() {
          var e = document.getElementById("upload_box"),
            t = function () {
              "true" !== e.getAttribute("x-selected") &&
          ...
          e.addEventListener("keypress", function (e) {
            ...
            e.addEventListener("drop", function (e) {
              x(e.dataTransfer.files), e.preventDefault();
            }),
            ...
            document
              ...
              .addEventListener("change", function (e) {
                x(e.target.files), e.preventDefault();
              });
        }
        (document.getElementById("upload_desc").innerHTML =
          t.default.upload_desc),
          (document.getElementById("code-loading-info").innerText =
            t.default.decompiling);
        var A = new Map();
        function I() {
          if (!L) {
            ...
            (w = new WebSocket(
              ""
                .concat("https:" === t.protocol ? "wss" : "ws", "://")
                .concat(t.host, "/v2/ws")
                .concat(e)
            ...
            var n = Date.now(),
              o = setInterval(function () {
                if (w.readyState === WebSocket.OPEN)
                  return Date.now() > n + 12e4
                    ? ((0, a.debugLog)("WS closed idle"), void w.close())
                    : void w.send("ping");
              }, 2e4);
            return (
              (w.onopen = function () {
                (0, a.debugLog)("WS connected");
              }),
              (w.onclose = function () {
                (0, a.debugLog)("WS closed"), clearInterval(o);
              }),
              (w.onmessage = function (e) {
                ...
                null == r
                  ? (0, a.debugLog)(
                      "callbackId ".concat(t.cbid, " refers to nothing.")
                    )
                  : (r.resolveFunc({ data: t }),
                    delete r.promise,
                    A.delete(t.cbid));
              }),
              w
        ...
        function _(e) {
          ...
          if (o)
            return Promise.resolve({
              data: {
                error: "Class file is too big (".concat(
                  (0, n.formatBytes)(o.length),
                  ")"
                ),
              },
            });
          ...
          if (
            (l.set(new Uint8Array([e.length]), c++),
            e.forEach(function (e) {
              l.set((0, n.int32Bytes)(e.length), c),
                (c += 4),
                l.set(e, c),
                (c += e.length);
            }),
            ...
            return Promise.resolve({
              data: {
                error: "Class file is too big (".concat(
                  (0, n.formatBytes)(l.length),
                  "), including inner classes."
                ),
              },
            });
          if (
            (null === (t = w) || void 0 === t ? void 0 : t.readyState) ===
              WebSocket.OPEN &&
            l.length < 65400 &&
            !L
          ) {
            var s = (0, n.randomString)();
            l.set(new Uint8Array((0, n.stringToBytes)(s)), c);
            var d = new Uint8Array(1 + "fernflower".length + l.length);
            d.set(new Uint8Array(["fernflower".length]), 0),
              d.set(new Uint8Array((0, n.stringToBytes)("fernflower")), 1),
            ...
            return A.set(s, u), u.promise;
          }
          var f,
            m = null === (f = w) || void 0 === f ? void 0 : f.readyState;
          (m && m !== WebSocket.CLOSING && m !== WebSocket.CLOSED) ||
            L ||
            (I(),
            (0, a.debugLog)(
              "WS is closed, trying to reconnect. Using POST fallback."
            ));
          ...
          return fetch("".concat(r.API_BASE, "/v2/decompile").concat(p), {
            ...
            return e.json().then(function (t) {
              return { headers: e.headers, data: t };
            });
          });
        }
        function k(e) {
          e = e.replace(/"/g, '\\"');
          var t = s(document.querySelectorAll("span.token.string")).filter(
            function (t) {
        ...
        function j(e, t, o) {
          ...
          if (
            ...
            (i.className = s), i.appendChild(l), T();
          } else {
            var d = document.createElement("code");
            if (((d.textContent = e), t))
              try {
                i.classList.add("line-numbers"),
                  (d.className = "language-".concat(t)),
                  (0, a.debugTimeStart)("highlight"),
                  Prism.highlightElement(d, !1, function () {
                    (0, a.debugTimeStop)("highlight"),
                      (0, n.countLines)(e) > 999 &&
                        i.classList.add("line-numbers-lt-lg"),
                      i.appendChild(d),
                      Prism.plugins.lineNumbers.init({ code: e, element: d }),
                      o &&
                        P.set(o, {
                ...
                console.error(u), 0 === i.childElementCount && i.appendChild(d);
              }
            else i.appendChild(d);
          }
          document.querySelector("#code").classList.remove("loading"),
            document
              .querySelector("#code-loading-info")
        ...
        function R(e) {
          ...
          var t = document.querySelector(
            '.leaf[data-fullpath="'.concat(e, '"] a.title')
          );
          null == t || t.classList.add("active"), null == t || t.focus();
        }
        function q(e, t) {
              ...
              return regeneratorRuntime.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                      ...
                      if (
                        (((i =
                          document.getElementById(
                            "code-loading-info"
                          )).innerText = t.default.decompiling),
                    ...
                    case 14:
                      return (e.next = 16), Promise.all(m);
                    case 16:
                      return (h = e.sent), (e.next = 19), _(h);
                    case 19:
                      if (
                        ((g = e.sent),
                        (y = g.data),
                    ...
                    case 26:
                      (E = Date.now() - p),
                        ...
                        r.DISABLE_DECOMPILED_CODE_CACHE
                          ? v.delete(a)
                          : v.set(a, { code: b, lang: "java" });
                    case 33:
                    case "end":
                      return e.stop();
                  }
        ...
        function U(e, r) {
          var a = v.get(e),
            o = (0, n.explodePath)(e).fileName;
          if ((R(e), null == a)) {
            var i = (0, n.getFilePathExtension)(e);
            switch (i) {
              case "class":
              ...
              case "jar":
                ...
                (d.textContent = t.default.open_jar_new_tab.replace(
                  "$name",
                  o
                )),
                  (d.style.margin = "auto"),
                  ...
                  (d.onclick = function () {
                    ...
                    (window._loadFromParent = { zipPromise: t, fileName: o }),
              ...
              default:
                r.file(e)
                  .async("text")
                  .then(function (t) {
                    var r = (0, n.getFilePathExtension)(e),
                      a = r ? (0, n.getLanguageFromExtension)(r) || r : "none";
                    v.set(e, { code: t, lang: a }), j(t, a), F(o, t);
                  });
            }
          } else
            null != a.code &&
              (j(a.code, a.lang, e), F(o.replace(".class", ".java"), a.code));
        }
        function D() {
        ...
        function M(e) {
          ...
          D();
          var r = (0, n.explodePath)(e.name).fileName,
            a = null == e ? void 0 : e._data.uncompressedSize,
            o = a ? " (".concat((0, n.formatBytes)(a), ")") : "";
          (t.download = r),
            ...
            (B = function (n) {
              n.preventDefault(),
                e.async("arraybuffer").then(function (e) {
                  (t.href = URL.createObjectURL(new Blob([e]))), t.click();
                });
            }),
            t.addEventListener("click", B, { once: !0 }),
            (t.querySelector("span").textContent = r);
        }
        function F(e, t, r) {
          var a = document.getElementById("opened-file");
          D();
          var o = URL.createObjectURL(new Blob([t], { type: r || "" }));
          (a.download = e),
            (a.href = o),
            (a.title = "Download "
              .concat(e, " (")
              .concat((0, n.formatBytes)(t.length), ")")),
        ...
        function W(e) {
          ...
          return (function e(t) {
            ...
            try {
              for (a.s(); !(n = a.n()).done; ) {
                var o = n.value;
                r.push({ text: o, children: e(t.get(o)) });
              }
            } catch (p) {
              a.e(p);
            } finally {
            ...
            return t.$child && r.push.apply(r, s(t.$child)), r;
          })(n);
        }
        function H(e) {
          var t,
          ...
          return (
            e.forEach(function (e) {
              var t = e.name;
              if (-1 == t.lastIndexOf("/"))
                r.push({ text: t, dataAttr: { fullPath: t } });
              else {
                var o = (0, n.explodePath)(t),
                  i = o.folder,
                  c = o.fileName;
                if ("" === c) return;
                a[i] ||
                  ...
                  a[i].children.push({ text: c, dataAttr: { fullPath: t } });
              }
            }),
        ...
        function $(e) {
          ...
          e.forEach(function (e, n) {
            (E && !L && -1 !== e.indexOf("$") && e.endsWith(".class")) ||
              t.push(n);
          });
          return W(t);
        }
        function z(e, t) {
          (h = e), (0, a.debugTimeStart)("createTreeStructure");
          var n = $(e);
          function r(e) {
            e.code && Prism.plugins.lineNumbers.init(e);
          }
          (0, a.debugTimeStop)("createTreeStructure"),
            ue(),
            (document.getElementById("select_file").style.display = "none"),
            (0, a.debugTimeStart)("renderTree"),
            ee(document.getElementById("tree"), {
              data: { text: t.name, children: n, dataAttr: { "is-root": !0 } },
              sort: !0,
              expandFirstNode: !0,
            }),
            (0, a.debugTimeStop)("renderTree"),
            (document.getElementById("browse_files").style.display = ""),
            Le("load-jar"),
            L || (0, a.debugTimeStop)("jarload"),
            I(),
            b && e.file(b) && (me(b), (b = void 0)),
            document.querySelector(".folder[data-is-root] a.title").focus(),
            (we.tabIndex = oe + 1),
            -1 === Prism.hooks.all.complete.indexOf(r) &&
              Prism.hooks.add("complete", r);
        }
        function J(e) {
          var a = new URL(e).pathname,
            o = a.slice(a.lastIndexOf("/") + 1) || "Unnamed.jar";
          (document.getElementById("upload_desc").innerText =
            t.default.loading_from + e),
            document
              .getElementById("upload_box")
              .setAttribute("x-selected", "true"),
            fetch("".concat(r.API_BASE, "/pipe-url?u=").concat(e), {
              ...
              .then(function (e) {
                ...
                if (void 0 === e.body)
                  return Promise.resolve({ buffer: e.arrayBuffer() });
                ...
                return r.read().then(function e(s) {
                  if (s.done) {
                    ...
                    return Promise.resolve({ buffer: u });
                  }
                  (c += s.value.length), o.push(s.value);
                  var v = ((100 * c) / i).toFixed(1);
                  return (
                    (a.innerHTML = ""
                      .concat(t.default.downloading_file, "<p>")
                      .concat(v, "% (")
                      .concat((0, n.formatBytes)(c), " of ")
                      .concat((0, n.formatBytes)(i), ")</p>")),
              ...
              .catch(function (e) {
                switch (e.error) {
                  ...
                  case "ERR_NOT_FOUND":
                    G(
                      "A URL especificada aponta para um arquivo inexistente",
                      3e3
                    );
                    break;
                  default:
                    G(
                      "Não foi possível carregar o jar a partir da URL especificada. Erro inesperado.",
                      5e3
                    ),
                      console.error(e);
                }
        ...
        function K(e, n) {
          (0, a.debugTimeStart)("jarload"),
            JSZip.loadAsync(e)
              .catch(function (e) {
                console.error(e), G(t.default.invalid_jar, 2500);
              })
              .then(function (e) {
                return z(e, n);
              })
        ...
        function V(e, t) {
          var n = new JSZip();
          n.file(t.name, e), (L = !0), z(n, { name: "Root" }), U(t.name, n);
        }
        function Z(e) {
          if (null != e) {
            (g = e), (v = new Map()), (P = new Map()), (h = void 0), (L = !1);
        ...
        function G(e, n, r) {
          ...
          document.getElementById("upload_box").removeAttribute("x-selected"),
            ...
            setTimeout(function () {
              (a.innerHTML = t.default.upload_desc), (a.style.color = "black");
            }, n);
        }
        function Y(e) {
          try {
        ...
        function Q(e, t) {
          if ("META-INF" === e.text) return 190;
          var n = 1;
          return (
            void 0 !== e.children && (n += 100),
        ...
        function ee(e, t) {
          if (((e.innerHTML = ""), t.sort)) {
            (0, a.debugTimeStart)("sort"),
              X(t.data.children),
              (0, a.debugTimeStop)("sort");
          }
          var n = ie(t.data),
            r = document.createElement("ol");
          e.classList.add("inspire-tree"),
            t.expandFirstNode &&
              (n.classList.remove("collapsed"), n.classList.add("expanded")),
            r.appendChild(n),
            e.appendChild(r),
            ae(e);
        }
        ...
        function ne(e) {
          ...
          var r = parseInt(e.target.getAttribute("tabindex")),
            a = function () {
              return Array.from(
                document.querySelectorAll(".title[tabindex]")
              ).filter(function (e) {
        ...
        function re(e) {
          if (e.ctrlKey && "ArrowLeft" === e.key) {
            var t = C();
            if (t) {
              t.classList.add("return-focus"), t.focus();
              setTimeout(function () {
        ...
        function ie(e) {
          ...
          (r.className = t ? "collapsed folder" : "leaf"),
            e.dataAttr &&
              Object.keys(e.dataAttr).forEach(function (t) {
                r.setAttribute("data-".concat(t), e.dataAttr[t]);
              });
          var a = document.createElement("div");
          (a.class = "title-wrap"), r.appendChild(a);
          var o = document.createElement("a");
          if (
            ((o.innerText = e.text),
            (o.className =
              "title icon " + (t ? "icon-folder" : "icon-file-empty")),
            e.fileSize
              ? o.setAttribute(
                  "title",
                  ""
                    .concat(e.text, " (")
                    .concat((0, n.formatBytes)(e.fileSize), ")")
                )
              : o.setAttribute("title", e.text),
          ...
          if (e.classList.contains("folder")) {
            t
              ? (e.classList.remove("collapsed"),
                ...
                n.classList.add("icon-folder-open"))
              : (e.classList.add("collapsed"),
                e.classList.remove("expanded"),
                n.classList.add("icon-folder"),
                n.classList.remove("icon-folder-open"));
        ...
        function me(e) {
          ...
          if (t.length > 1)
            for (
              var n = document.querySelector("#tree > ol > li > ol"),
                r = function () {
                  var e = t.shift(),
                    r = s(n.querySelectorAll(":scope > li.folder")).find(
                      function (t) {
                        return t.querySelector("a.title").innerText === e;
                      }
                    );
                  if (!r) return "break";
                  ce(r), (n = r.querySelector("ol"));
                };
              n && t.length > 0;
        ...
        function pe(e) {
          var t = e.jarFile,
            n = e.path,
            r = e.highlight;
          (y = r), void 0 === g || t.name !== g.name ? (Z(t), (b = n)) : me(n);
        }
        var ve = "https://leonardosnt.github.io/";
        function he(e) {
          var t = new URL(e.origin).hostname;
          (t !== new URL(ve).hostname && t !== location.hostname) ||
            ("open" === e.data.action
              ? pe(e.data)
              : console.warn("Invalid action received:", e.data.action));
        }
        function ge(e) {
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 7:
                        z(e.sent, { name: o }), (e.next = 15);
                        break;
                      case 11:
                        (e.prev = 11),
                          (e.t0 = e.catch(3)),
                          (document.getElementById("upload_desc").innerText =
                            "Failed to open jar: ".concat(e.t0)),
                          console.error(e.t0);
                      case 15:
        ...
        function be() {
          ...
          e &&
            ge(e).catch(function (e) {
              return (0, a.debugLog)(e);
            }),
            e &&
              -1 !== location.search.indexOf("jse") &&
              e.postMessage("app-ready", "*");
        }
        function Le(e, t, n, r) {
          try {
            "function" == typeof window.ga &&
              ((t = t || e), window.ga("send", "event", e, t, n, r));
          } catch (a) {
            console.error(a);
          }
        }
        ...
        we.addEventListener("keydown", re),
          ...
          window.addEventListener("keydown", function (e) {
            return (
              "Tab" === e.key && document.body.classList.remove("using-mouse")
            );
          }),
