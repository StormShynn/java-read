      ...
      function (require, module, exports) {
        ...
        var e = arguments[3],
          ...
          r = (function (e) {
              ...
              t = {
                ...
                util: {
                  ...
                  objId: function (e) {
                    return (
                      e.__id ||
                        Object.defineProperty(e, "__id", { value: ++r }),
                      e.__id
                    );
                  },
                  clone: function e(n, r) {
                    ...
                    switch (((r = r || {}), i)) {
                      case "Object":
                        if (((l = t.util.objId(n)), r[l])) return r[l];
                        for (var o in ((a = {}), (r[l] = a), n))
                  ...
                  currentScript: function () {
                    ...
                    try {
                      ...
                      if (e) {
                        ...
                        for (var r in n) if (n[r].src == e) return n[r];
                      }
                      return null;
                    }
                  },
                ...
                highlightElement: function (r, a, l) {
                  ...
                  if ((t.hooks.run("before-sanity-check", u), !u.code))
                    return (
                      t.hooks.run("complete", u), void (l && l.call(u.element))
                    );
                ...
                highlight: function (e, n, r) {
                  var l = { code: e, grammar: n, language: r };
                  return (
                    t.hooks.run("before-tokenize", l),
                ...
                hooks: {
                  ...
                  run: function (e, n) {
                    var r = t.hooks.all[e];
                    if (r && r.length) for (var a, l = 0; (a = r[l++]); ) a(n);
                  },
                },
                Token: a,
              };
            ...
            return s && ((t.filename = s.src), (t.manual = !0)), t;
          })(n);
        ...
        !(function () {
            ...
            Prism.hooks.add("complete", function (e) {
              e.element &&
                ...
                (function (e, t) {
                  ...
                  !s &&
                    c &&
                    "pre" === c.tagName.toLowerCase() &&
                    (s = c.getAttribute("data-dependencies")),
          ...
          function r(r, l, n) {
            ...
            var o = function () {
                ...
                if (
                  (e || (e = t[r] = { callbacks: [] }),
                  e.callbacks.push({ success: l, error: n }),
                  !p && Prism.languages[r])
                )
                  c(r, "success");
                else if (!p && e.error) c(r, "error");
                else if (p || !e.loading) {
                  (e.loading = !0),
                    (function (e, a, t) {
                      ...
                      function () {
                        (e.loading = !1), c(r, "success");
                      },
                      function () {
                        (e.loading = !1), (e.error = !0), c(r, "error");
                      }
                    );
                }
              },
          ...
          if ("undefined" != typeof self && self.Prism && self.document) {
            ...
            Prism.hooks.add("line-numbers", function (e) {
              ...
              (Prism.plugins.lineNumbers = {
                init: function (n) {
                  var i = n.element;
                  if ((i.parentNode, !i.querySelector(".line-numbers-rows"))) {
